...
export const subjects: Subject[] = [
  ...
  {
    key: 'anglais-langue-seconde',
    label: 'Anglais, langue seconde',
    domain: 'langues-secondes',
    icon: '🇬🇧',
    availableInCycles: ['cycle1-primaire', 'cycle2-primaire', 'cycle3-primaire']
  },
  {
    key: 'education-physique-sante',
  ...
  {
    key: 'ethique-culture-religieuse',
    label: 'Éthique et culture religieuse',
    domain: 'developpement-personnel',
    icon: '🤝',
    availableInCycles: ['cycle1-primaire', 'cycle2-primaire', 'cycle3-primaire']
  }
